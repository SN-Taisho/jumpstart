...
<main>
	<div class="width-limiter" style="padding: 0rem 2rem;">
		...
		<table class="res-table" style="max-width: 922px;">
			<caption>
				Category Managment
				...
				<c:forEach items="${categories }" var="c" varStatus="item">
					<tr>
						...
						<td class="actions" data-label="Actions">
							...
							<button class="action-btn delete" onclick="window.location.href='delete_category?cId=${c.id}'">Delete</button>
						</td>
					</tr>
				</c:forEach>
			</tbody>
...
<c:forEach items="${categories }" var="c" varStatus="item">
	<dialog id="editCategoryModal${item.count }" class="modal">
